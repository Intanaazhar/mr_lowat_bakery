...
class CookieCategoryPage extends StatefulWidget {
  const CookieCategoryPage({super.key});

  @override
  _CookieCategoryPageState createState() => _CookieCategoryPageState();
}

class _CookieCategoryPageState extends State<CookieCategoryPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection('cookies').snapshots(), // Changed to 'cookies'
